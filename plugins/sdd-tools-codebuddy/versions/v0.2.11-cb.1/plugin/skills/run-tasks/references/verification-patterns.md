...
For common task-level mistakes that affect verification results, see the claude-code-tasks anti-patterns reference (`${CODEBUDDY_PLUGIN_ROOT}/../agent-alchemy-claude-tools/skills/claude-code-tasks/references/anti-patterns.md`).
