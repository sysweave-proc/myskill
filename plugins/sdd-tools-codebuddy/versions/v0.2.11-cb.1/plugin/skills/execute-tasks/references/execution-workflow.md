...
This reference provides the detailed 4-phase workflow for executing a single CodeBuddy Task. Each phase has specific procedures depending on whether the task is spec-generated or a general task.
...
```
Read: .codebuddy/sessions/__live_session__/execution_context.md
```
...
1. Read `CODEBUDDY.md` for project conventions, tech stack, and coding standards
...
- **Read CODEBUDDY.md conventions**: Apply any project-specific rules
