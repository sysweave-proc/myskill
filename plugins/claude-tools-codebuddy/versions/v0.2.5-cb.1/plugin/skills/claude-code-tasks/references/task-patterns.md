...
Proven patterns for structuring CodeBuddy Tasks in multi-agent and single-agent workflows. This reference covers dependency graph design, task sizing, coordination strategies, and metadata conventions.
