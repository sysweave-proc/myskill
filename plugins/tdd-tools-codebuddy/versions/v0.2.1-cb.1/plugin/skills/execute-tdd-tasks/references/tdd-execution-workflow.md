...
| Session directory | `.codebuddy/sessions/__live_session__/` | Same structure and lifecycle |
...
| Execution pointer | `~/.codebuddy/tasks/{TASK_LIST_ID}/execution_pointer.md` | Same location and format |
...
2. `max_parallel` in `.codebuddy/agent-alchemy.local.md` (settings file)
3. Default: **5**
...
| 9. Update CODEBUDDY.md | Review for changes | Same |
