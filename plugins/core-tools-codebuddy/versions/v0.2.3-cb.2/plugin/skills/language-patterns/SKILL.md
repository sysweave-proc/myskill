...
description: Provides language-specific patterns for TypeScript, Python, and React including idioms, best practices, and common patterns. Use when implementing features in these languages. 中文触发（用户这样说时使用）：TypeScript/Python/React 怎么写更地道、语言习惯用法、这门语言的最佳实践。
version: 0.2.3
---
