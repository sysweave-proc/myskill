---
name: code-quality
description: Provides code quality principles including SOLID, DRY, testing strategies, and best practices for implementation review. Use when reviewing code or applying quality standards. 中文触发（用户这样说时使用）：代码质量、SOLID/DRY、可维护性、重构建议、按什么标准评审代码。
version: 0.3.4
---
