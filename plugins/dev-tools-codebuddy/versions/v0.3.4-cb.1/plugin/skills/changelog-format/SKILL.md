...
description: Keep a Changelog format guidelines and entry writing best practices. Use when writing changelog entries, updating CHANGELOG.md, or following Keep a Changelog specification. 中文触发（用户这样说时使用）：写 changelog、更新 CHANGELOG.md、Keep a Changelog 格式、整理版本变更记录。
version: 0.3.4
---
