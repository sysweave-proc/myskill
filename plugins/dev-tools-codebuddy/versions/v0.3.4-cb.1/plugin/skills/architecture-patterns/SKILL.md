...
description: Provides architectural pattern knowledge for designing feature implementations including MVC, event-driven, microservices, and CQRS patterns. Use when designing system architecture or choosing implementation patterns. 中文触发（用户这样说时使用）：设计系统架构、选架构模式、MVC/事件驱动/微服务/CQRS 怎么选、实现方案怎么分层。
version: 0.3.4
---
