---
name: docs-manager
description: Documentation management workflow for MkDocs sites and standalone markdown files — initialize, generate, update docs, and create change summaries. Use when asked to "create docs", "write README", "update documentation", "generate docs site", "write CONTRIBUTING", "manage documentation", or "docs changelog". 中文触发（用户这样说时使用）：写文档、生成文档站点、更新 README、维护 MkDocs、写 CONTRIBUTING、文档变更摘要。
version: 0.3.4
...
1. Load `${CODEBUDDY_PLUGIN_ROOT}/skills/docs-manager/references/mkdocs-config-template.md`
...
- If `DOC_TYPE = change-summary`: Read `${CODEBUDDY_PLUGIN_ROOT}/skills/docs-manager/references/change-summary-templates.md`
- If `DOC_TYPE = basic-markdown`: Read `${CODEBUDDY_PLUGIN_ROOT}/skills/docs-manager/references/markdown-file-templates.md`
